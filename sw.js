...
const CACHE = 'spliceworld-v60-4dfe5856';
...
const SHELL = [
  ...
  'audio/voice.js',
  // R111: the room tone and the haptics. Lazy, to keep them out of the eager
  // budget; precached for the same reason as the voice — offline gets all of it.
  'audio/room.js',
  'data/breakout.json',
  'data/taskforce.json',
  'data/legacy.json',
